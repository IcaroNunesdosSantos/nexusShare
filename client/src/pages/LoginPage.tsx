  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4">
      ...
      <form onSubmit={onSubmit} className="space-y-4 rounded-2xl border border-white/10 bg-ink-800/80 p-6">
        ...
        <Input label="Senha" type="password" name="password" autoComplete="current-password" required value={password} onChange={(e) => setPassword(e.target.value)} />
        ...
        <p className="text-center text-sm text-slate-400">
          Não tem conta?{" "}
          <Link className="text-accent-400 hover:underline" to="/register">
            Criar conta
          </Link>
        </p>
      </form>
